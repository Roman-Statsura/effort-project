...
trait JobFixture {
  ...
  val SrsJobWithNotFoundId = AwesomeJob.copy(id = NotFoundJobUuid)
  ...
  val SrsAwesomeJob =
    AwesomeJob.copy(jobInfo = AwesomeJob.jobInfo.copy(company = "Lala"))
